 ...
 return (
  <div>
   ...
   {DIFFICULTY.map((obj, i) => (
    <div
     key={i}
     className={classNames(style.difficulty, style[obj.mode.toLowerCase()])}
     onClick={() => setDifficulty(obj)}
    >
     <h4>{obj.mode}</h4>
     <p>{obj.description}</p>
    </div>
   ...
   <p>
    Kindly play the <a href='https://mathler.com'>Original Mathler</a> for a better experience.
   </p>
  </div>
 )
}
