...
const useMathler = (solution:string,size:number) => {
    ...
    const addNewGuess = (formattedGuess:Guess) => {
        ...
        setUsedKeys((prevUsedKeys) => {
            ...
            formattedGuess.forEach((guess,i) => {
    ...
    return {trial,currentGuess,guesses,history,isCorrect,handleKeyUp,addNewGuess,formatGuess,usedKeys,NUM_TRIALS,error,clearError,handleKeyboardEvent};
}
